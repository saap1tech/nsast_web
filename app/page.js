  ...
  return (
   ...
   <div className="relative z-10">
        <section className="text-center py-52 px-40">
          ...
          <BlurryBlob
  firstBlobColor="bg-[#07BEB8]"   // Custom color for the first blob
  secondBlobColor="bg-[#07BEB8]"  // Custom color for the second blob
  className="absolute top-0 right-0 w-[200px] h-[300px]"  // Positioned to the top right corner
/>
